extension ListExt<T> on List<T>? {
  ...
  List<T> insertFirst(T data, {bool Function(T element)? removeIfDuplicate}) {
    if (removeIfDuplicate != null) {
      return (this ?? [])
                  .firstOrElseNull((element) => removeIfDuplicate(element)) !=
              null
          ? this ?? []
          : [data, ...(this ?? [])];
    }
  ...
  List<T> insertLast(T data, {bool Function(T element)? removeIfDuplicate}) {
    if (removeIfDuplicate != null) {
      return (this ?? [])
                  .firstOrElseNull((element) => removeIfDuplicate(element)) !=
              null
